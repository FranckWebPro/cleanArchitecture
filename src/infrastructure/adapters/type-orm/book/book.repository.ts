...
title,
 ...
 author,
  totalPages
        ...
        const book = await AppDataSource.getRepository(BookDBEntity).findOneBy({id: bookIdentifier.id});
  ...
  async delete(id: string): Promise<boolean> {
    ...
    const deleteResult = await AppDataSource.getRepository(BookDBEntity).delete({id: id});
